...
![Скриншот панели: каналы PRIMARY / FAILOVER / AI / YouTube / «Заблокированные в РФ» и переключение watchdog](docs/screenshot.png)

> *Скриншот на демонстрационных данных (выдуманные серверы) — реальные адреса/ключи не показаны.*
